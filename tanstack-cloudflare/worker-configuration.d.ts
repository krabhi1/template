/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3c91dc57e11595264f6471f56f9d191d)
// Runtime types generated with workerd@1.20260120.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/entry-worker");
	}
	interface Env {
		R2: R2Bucket;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY">> {}
}
